...
<style>body{margin:0;background:#000;overflow:hidden;}img{width:67%;position:absolute;margin-left:50%;transform:translateX(-50%);height:auto;display:block;}</style>
</head>
